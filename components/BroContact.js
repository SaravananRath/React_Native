...
export default class BroContact extends React.Component {
  render() {
    return (
      <View key={this.props.keyval} style={styles.note}>
        <View style={styles.content}>
          ...
          <View style={styles.buttonview}>
            <TouchableOpacity
              onPress={this.props.addMethod}
              style={styles.noteUpdate}
            >
              <Text style={styles.noteUpdateText}>Add</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
